    ...
    <div class="container">
      ...
      <CardModal v-if="showForm" @close="showForm = false">
        <div class="input-title" slot="title">
          ...
          <input class="input" type="text" placeholder="タイトル">
        </div>
        <input class="input" type="text" placeholder="サブタイトル" slot="subtitle">
        <textarea class="textarea has-fixed-size" placeholder="本文" slot="body"></textarea>
        <button class="button is-rounded has-text-centered" slot="footer">投稿</button>
      </CardModal>
