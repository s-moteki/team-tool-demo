  ...
  <section class="section" v-if="boards">
    <div class="container">
      ...
      <CardModal v-if="showForm" @close="showForm = false">
        <div class="control" slot="title" row="1">
          <textarea class="textarea has-fixed-size" placeholder="タイトルを入力してください"></textarea>
        </div>
        <div class="control" slot="body">
          <textarea class="textarea has-fixed-size" placeholder="本文を入力してください"></textarea>
        </div>
      </CardModal>
    </div>
  </section>
