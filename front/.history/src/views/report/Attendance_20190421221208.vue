...
export default {
  ...
  mounted () {
    this.attendance = [
        {attendance_id:'1', date: '2019-04-03', type_id: 3, start: '12:00', end: '18:00', remarks: '体調不良'},
        {attendance_id:'2', date: '2019-04-05', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
        {attendance_id:'3', date: '2019-04-07', type_id: 1, start: '18:00', end: '23:00', remarks: ''},
        {attendance_id:'4', date: '2019-04-08', type_id: 2, start: '', end: '', remarks: ''},
        {attendance_id:'5', date: '2019-04-12', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
      ]
