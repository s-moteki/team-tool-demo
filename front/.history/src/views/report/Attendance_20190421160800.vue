...
export default {
  ...
  methods: {
    ...
    // 年月日→日(曜日)
    editDispDate(date){
      const date = new Date(date.replace(/-/g,'/'))
      return date.getDate() +
    }
  },
  mounted () {
    this.attendance = [
        ...
        {id:'2', date: '2019-4-3', type: '残業', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
        {id:'3', date: '2019-4-3', type: '残業', type_id: 1, start: '18:00', end: '23:00', remarks: ''},
        {id:'4', date: '2019-4-3', type: '休み', type_id: 2, start: '--:--', end: '--:--', remarks: ''},
        {id:'5', date: '2019-4-3', type: '残業', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
      ]
  }
}
</script>
