      ...
      <div class="inputForm" slot="body">
        <div class="field is-horizontal">
          ...
          <div class="field-body">
            <div class="field">
              <input class="input" type="date" :value="showForm.day">
            </div>
...
export default {
  ...
  mounted () {
    this.attendance = [
        {id:'1', day: '8 (月)', type: '早退', type_id: 3, start: '12:00', end: '18:00', remarks: '体調不良'},
        ...
        {id:'4', day: '16(木)', type: '休み', type_id: 2, start: '--:--', end: '--:--', remarks: ''},
