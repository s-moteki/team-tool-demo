...
export default {
  ...
  data () {
    return {
      attendance: [
        {id:'1', day: '10/8', type: '早退', start: '12:00', end: '18:00', remarks: '-'},
        {id:'2', day: '10/9', type: '残業', start: '18:00', end: '19:00', remarks: '-'},
        {id:'3', day: '10/12', type: '残業', start: '18:00', end: '23:00', remarks: '-'},
        {id:'4', day: '10/16', type: '全休', start: '--:--', end: '--:--', remarks: '-'},
        {id:'5', day: '10/20', type: '残業', start: '18:00', end: '19:00', remarks: '-'},
      ]
    }
  },
  methods: {
