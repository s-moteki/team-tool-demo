<template>
  <div class="attendance has-text-centered">
    <div class="select">
      <select>
        <option>今月</option>
        <option v-for="month in months" :key="month.date">{{month.date}}</option>
      </select>
    </div>
    <!-- 勤怠報告一覧 -->
    ...
    <CardModal v-if="showForm" @close="showForm = null">
      ...
      <button id="addButton" class="button is-fullh" slot="footer" @click="editAttendance(showForm.id)">完了</button>
    </CardModal>
    ...
    <!-- 勤怠追加ボタン -->
    <button v-if="!submission" class="button add icon" @click="showForm = {id: null, date: '', type_id: '', start: '', end: '', remarks: ''}">
...
export default {
  ...
  mounted () {
    this.attendance = [
        {id:'1', date: '2019-04-03', type_id: 3, start: '12:00', end: '18:00', remarks: '体調不良'},
        {id:'2', date: '2019-04-05', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
        {id:'3', date: '2019-04-07', type_id: 1, start: '18:00', end: '23:00', remarks: ''},
        {id:'4', date: '2019-04-08', type_id: 2, start: '', end: '', remarks: ''},
        {id:'5', date: '2019-04-12', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
      ]
    this.submission = false
    this.months = [
        {date:'2019-04', submission: false},
        {date:'2019-05', submission: true},
        {date:'2019-06', submission: true}
    ]
  }
}
</script>
