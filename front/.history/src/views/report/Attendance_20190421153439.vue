          ...
          <div class="field-body">
            <div class="field">
              <div class="select">
                ...
                <select :selected="showForm.type_id" :options="options"/>
              </div>
            </div>
          </div>
          <div class="field-body">
...
export default {
  ...
  mounted () {
    this.attendance = [
        {id:'1', day: '8 (月)', type: '早退', type_id: 2, start: '12:00', end: '18:00', remarks: '体調不良'},
        {id:'2', day: '9 (火)', type: '残業', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
        {id:'3', day: '12(水)', type: '残業', type_id: 1, start: '18:00', end: '23:00', remarks: ''},
        {id:'4', day: '16(木)', type: '休み', type_id: 3, start: '--:--', end: '--:--', remarks: ''},
        {id:'5', day: '20(月)', type: '残業', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
      ]
  }
}
</script>
