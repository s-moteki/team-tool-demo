    ...
    <table class="table is-striped is-hoverable table-to-export">
      ...
      <tbody>
        ...
        @click="showForm = data">
          ...
          <td>{{getTypeName(datea.type_id)}}</td>
          <td>{{data.start}}</td>
          <td>{{data.end}}</td>
          <td>{{data.remarks != '' ? '有' : '無'}}
...
export default {
  ...
  methods: {
    ...
    getTypeName (id) {
      this.types.find(type => { return typs.value == id })
    }
  },
  mounted () {
    this.attendance = [
        {id:'1', date: '2019-04-03', type: '早退', type_id: 3, start: '12:00', end: '18:00', remarks: '体調不良'},
        {id:'2', date: '2019-04-05', type: '残業', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
        {id:'3', date: '2019-04-07', type: '残業', type_id: 1, start: '18:00', end: '23:00', remarks: ''},
        {id:'4', date: '2019-04-08', type: '休み', type_id: 2, start: '', end: '', remarks: ''},
        {id:'5', date: '2019-04-12', type: '残業', type_id: 1, start: '18:00', end: '19:00', remarks: ''},
      ]
  }
}
</script>
