...
<section>
  <transition name="fade-fast" mode="out-in">
    <div class="attendance has-text-centered" v-if="attendance">
      ...
      <!-- 削除モーダル -->
      <CardModal v-if="deleteSign" @close="showAlert = null">
        <div class="input-title" slot="body">
          <p>提出しますか?</p>
        </div>
        <div slot="footer" class="buttons is-centered">
          <button class="button is-success" @click="sendMail">はい</button>
          <button class="button is-danger" @click="showAlert = null">いいえ</button>
        </div>
      </CardModal>


      <!-- 提出ボタン -->
      <button  :disabled="submission" class="button send" @click="showAlert = true">
