...
<section>
  <transition name="fade-fast" mode="out-in">
    <div class="attendance has-text-centered" v-if="attendance">
      ...
      <!-- 勤怠追加ボタン -->
      <button v-if="!submission" class="button add icon" @click="showForm = {attendance_id: null, date: '', type_id: '', start: '', end: '', remarks: '', user_oid: user_oid, year: selectedYM.slice(0, 4), month: selectedYM.slice(-2)}">
