...
export default {
  ...
  methods: {
    ...
    addNotice () {
      ...
      axios.post('https://moteki1236.sakura.ne.jp/team-tool/api/notices', this.createNoticeForm)
        .then(response => {
          alert('投稿が完了しました')
    ...
    // おしらせ削除
    deleteNotice (id) {
      axios.delete(`https://moteki1236.sakura.ne.jp/team-tool/api/notices/${id}`)
        .then(response => {
          alert('削除が完了しました')
          this.resetDisplay(response.data)
          this.setDeleteSign()
    ...
    updateNotice () {
      ...
      axios.put(`https://moteki1236.sakura.ne.jp/team-tool/api/notices/${this.updateNoticeForm.id}`, this.updateNoticeForm)
        .then(response => {
          alert('更新が完了しました')
          this.resetDisplay(response.data)
  ...
  mounted () {
    // お知らせ一覧api
    axios.get('https://moteki1236.sakura.ne.jp/team-tool/api/notices')
    .then(response => {
